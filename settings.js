...
SESSION_ID: process.env.SESSION_ID === undefined ? 'SKELETON-MD=DqohmLYA#8ltr3Wmu6d5PCx5Nh2COV_qLrdyIOT6-Klp0q_xqyl1' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SESSION_NAME: process.env.SESSION_NAME === undefined ? "SKELETON" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , I am alive now for you!!*" : process.env.ALIVE_MSG,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "mrskeleton2025@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "mrskeletonpro" : process.env.SEEDER_PASSWORD,
